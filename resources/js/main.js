        ...
        for (var i = 0; i < curPerson["events"].length; i++) {
            ...
            switch (event[event.length - 1]) { // We take the letter indicating event type
                case "B": // Birth
                    ...
                    try {
                        ...
                        if ((birthDate != "") && (birthDate != null)) {
                            ...
                            birthInfo.appendChild(document.createTextNode(` (${yearsOld.toString()} ${langArray["yearsAgo"]})`));
                        }
                    }
                    catch (e) {
                        dateStr = birthDate;
                ...
                case "D": // Death
                    ...
                    field(dateStr, langArray["died"][sex] + deathLocation + deathType + ageAtDeathStr);
                    break;
...
function View(data) {
    ...
    var initialDict = {
        ...
        // @ts-ignore
        recreateTree: function () { this.setFocus(this.focusId); },
        ...
        showDetailedView: function (personId) {
            var thisEl = this;
            this.lookupDetails(personId, function (thisDetails) {
                if (thisDetails == null) {
